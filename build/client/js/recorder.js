...
var stream;
var recorder;
var videoFile; // 1. 스트링은 틀리기 쉬우니까 이렇게 바꾸기
...
var handleDownload = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var ffmpeg, mp4File, thumbFile, mp4Blob, thumbBlop, mp4Url, thunbUrl;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            ...
            thumbBlop = new Blob([thumbFile.buffer], {
              type: "image/jpg"
            });
            mp4Url = URL.createObjectURL(mp4Blob);
            thunbUrl = URL.createObjectURL(thumbBlop);
